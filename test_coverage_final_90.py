...
def test_splay_tree_single_element_final_90():
...
def test_splay_tree_merge_split_single_final_90():
...
def test_splay_tree_performance_single_final_90():
...
def test_splay_tree_validation_single_final_90():
...
def test_splay_tree_print_single_final_90():
...
def test_splay_tree_string_representations_single_final_90():
...
def test_splay_node_advanced_single_final_90():
...
def test_splay_tree_comparator_single_final_90():
...
def test_splay_node_edge_cases_final_90():
...
if __name__ == "__main__":
    test_splay_tree_final_90()
    test_splay_node_final_90()
    test_splay_tree_single_element_final_90()
    test_splay_tree_merge_split_single_final_90()
    test_splay_tree_performance_single_final_90()
    test_splay_tree_validation_single_final_90()
    test_splay_tree_print_single_final_90()
    test_splay_tree_string_representations_single_final_90()
    test_splay_node_advanced_single_final_90()
    test_splay_tree_comparator_single_final_90()
    test_splay_node_edge_cases_final_90()
