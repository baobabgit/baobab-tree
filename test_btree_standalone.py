#!/usr/bin/env python3
"""
Script de test pour la version autonome des classes B-tree.
"""

from btree_standalone import (
    BTree,
    BTreeNode,
    BTreeError,
    InvalidOrderError,
...
def main():
    ...
    print("Démarrage des tests B-tree autonomes...")
