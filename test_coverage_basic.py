#!/usr/bin/env python3
"""
Test basique pour mesurer la couverture de code des modules SplayTree.
Évite toutes les opérations de splay problématiques.
"""
...
def test_splay_node_basic():
    """Test basique pour SplayNode."""
...
if __name__ == "__main__":
    ...
    test_splay_node_basic()
    print("Basic coverage test completed successfully")