#!/usr/bin/env python3
"""
Test complet pour atteindre 90%+ de couverture de code des modules SplayTree.
"""
...
def test_splay_tree_comprehensive():
    """Test complet pour SplayTree."""
    
    # Test constructeur et initialisation
    tree = SplayTree()
    tree_with_comp = SplayTree(lambda a, b: a - b)
    
    # Test insertion et opérations de base
    tree.insert(5)
    tree.insert(3)
    tree.insert(7)
...
def test_splay_node_comprehensive():
    """Test complet pour SplayNode."""
...
def test_exception_handling():
    ...
    try:
        ...
        tree._create_node = lambda value, parent=None: (_ for _ in ()).throw(Exception("Test error"))
        tree.insert(5)
    ...
    try:
        ...
        tree._zig = lambda n: (_ for _ in ()).throw(Exception("Test error"))
        tree._zig(node)
    except SplayOperationError:
        pass
    
    # Test SplayValidationError
    try:
        tree = SplayTree()
        # Simuler une erreur de validation
        tree.is_valid = lambda: (_ for _ in ()).throw(Exception("Test error"))
        tree.is_valid()
    except SplayValidationError:
        pass
...
def test_edge_cases():
    ...
    tree_custom.insert(3)
    tree_custom.insert(7)
    tree_custom.get_min()  # Devrait retourner 7
    tree_custom.get_max()  # Devrait retourner 3
...
if __name__ == "__main__":
    test_splay_tree_comprehensive()
    test_splay_node_comprehensive()
