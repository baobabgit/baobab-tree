...
class TestBSTErrorCases(unittest.TestCase):
    ...
    def test_search_error_handling(self):
        ...
        with patch.object(bst, '_search_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
                bst.search(50)
    ...
    def test_is_valid_error_handling(self):
        ...
        with patch.object(bst, '_is_valid_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
                bst.is_valid()
    ...
    def test_is_balanced_error_handling(self):
        ...
        with patch.object(bst, '_is_balanced_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
                bst.is_balanced()
    ...
    def test_find_floor_error_handling(self):
        ...
        with patch.object(bst, '_find_floor_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
                bst.find_floor(50)
    ...
    def test_find_ceiling_error_handling(self):
        ...
        with patch.object(bst, '_find_ceiling_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
                bst.find_ceiling(50)
    ...
    def test_range_query_error_handling(self):
        ...
        with patch.object(bst, '_range_query_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
    ...
    def test_count_range_error_handling(self):
        ...
        with patch.object(bst, '_count_range_recursive', side_effect=Exception("Test error")):
            with self.assertRaises(BSTError) as context:
