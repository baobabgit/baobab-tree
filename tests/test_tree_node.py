...
class TestTreeNode:
    ...
    def test_add_child_circular_reference(self):
        ...
        assert "Adding this child would create a circular reference" in str(exc_info.value)
    ...
    def test_set_parent_circular_reference(self):
        ...
        assert "Setting this parent would create a circular reference" in str(exc_info.value)
