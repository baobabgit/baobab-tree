"""
Tests unitaires pour la classe PreorderTraversal.

Ce module contient tous les tests unitaires pour la classe PreorderTraversal
et ses fonctionnalités de parcours préfixe.
"""

import pytest

from src.baobab_tree.spatial.preorder_traversal import PreorderTraversal
...
class TestPreorderTraversal:
    """Tests pour la classe PreorderTraversal."""

    def test_init_default_name(self):
        """Test de l'initialisation avec nom par défaut."""
        traversal = PreorderTraversal()
        assert traversal.get_traversal_name() == "Preorder"

    def test_init_custom_name(self):
        """Test de l'initialisation avec nom personnalisé."""
        traversal = PreorderTraversal("CustomPreorder")
        assert traversal.get_traversal_name() == "CustomPreorder"
    ...
    def test_str_representation(self):
        ...
        traversal = PreorderTraversal("TestPreorder")
        str_repr = str(traversal)
        assert "PreorderTraversal" in str_repr
        assert "TestPreorder" in str_repr

    def test_repr_representation(self):
        """Test de la représentation détaillée."""
        traversal = PreorderTraversal("TestPreorder")
        repr_str = repr(traversal)
        assert "PreorderTraversal" in repr_str
        assert "TestPreorder" in repr_str
