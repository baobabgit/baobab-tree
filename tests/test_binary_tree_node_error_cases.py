...
from src.exceptions import InvalidNodeOperationError, NodeValidationError, CircularReferenceError
...
class TestBinaryTreeNodeErrorCases(unittest.TestCase):
    ...
    def test_set_left_circular_reference(self):
        ...
        self.assertIn("Adding this child would create a circular reference", str(context.exception))
    ...
    def test_add_child_too_many_children(self):
        ...
        self.assertIn("Binary tree node cannot have more than 2 children", str(context.exception))
    ...
    def test_validate_binary_tree_property(self):
        ...
        self.assertIn("Children list does not match left and right children", str(context.exception))
        self.assertEqual(context.exception.validation_rule, "binary_tree_node_children_consistency")
