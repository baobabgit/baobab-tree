#!/usr/bin/env python3
"""
Test avancé pour améliorer la couverture de code des modules SplayTree.
"""

from src.baobab_tree.specialized.splay_tree import SplayTree
from src.baobab_tree.specialized.splay_node import SplayNode

def test_splay_tree_advanced():
    """Test avancé pour SplayTree."""
...
def test_splay_node_advanced():
    """Test avancé pour SplayNode."""
...
def test_splay_tree_with_multiple_elements():
    """Test avec plusieurs éléments."""
    
    tree = SplayTree()
    
    # Test insertion de plusieurs éléments
    tree.insert(5)
    tree.insert(3)
    tree.insert(7)
    tree.insert(1)
...
def test_splay_tree_merge_split():
    """Test de fusion et division."""
...
def test_splay_tree_performance():
...
def test_splay_tree_validation():
    """Test de validation."""
...
def test_splay_tree_string_representations():
...
if __name__ == "__main__":
    test_splay_tree_advanced()
    test_splay_node_advanced()
    test_splay_tree_with_multiple_elements()
    test_splay_tree_merge_split()
    test_splay_tree_performance()
    test_splay_tree_validation()
    test_splay_tree_print()
    test_splay_tree_string_representations()
    test_splay_node_advanced()
    print("Advanced coverage test completed successfully")