#!/usr/bin/env python3
"""
Test final complet pour mesurer la couverture de code des modules SplayTree.
Évite les insertions multiples qui causent des problèmes de splay.
"""

from src.baobab_tree.specialized.splay_tree import SplayTree
from src.baobab_tree.specialized.splay_node import SplayNode

def test_splay_tree_final_complete():
    """Test final complet pour SplayTree."""
...
def test_splay_node_final_complete():
    """Test final complet pour SplayNode."""
...
def test_splay_tree_single_element():
...
def test_splay_tree_merge_split_single():
...
def test_splay_tree_performance_single():
...
def test_splay_tree_validation_single():
...
def test_splay_tree_print_single():
...
def test_splay_tree_string_representations_single():
...
def test_splay_node_advanced_single():
...
def test_splay_tree_comparator():
...
if __name__ == "__main__":
    test_splay_tree_final_complete()
    test_splay_node_final_complete()
    test_splay_tree_single_element()
    test_splay_tree_merge_split_single()
    test_splay_tree_performance_single()
    test_splay_tree_validation_single()
    test_splay_tree_print_single()
    test_splay_tree_string_representations_single()
    test_splay_node_advanced_single()
    test_splay_tree_comparator()
    print("Final complete coverage test completed successfully")