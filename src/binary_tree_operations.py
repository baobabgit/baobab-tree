...
class BinaryTreeOperations(TreeOperations[T]):
    ...
    def _find_insertion_point(self, root: BinaryTreeNode[T]) -> Optional[BinaryTreeNode[T]]:
        """
    ...
    def _delete_recursive(self, node: BinaryTreeNode[T], value: T) -> Tuple[Optional[TreeNode[T]], bool]:
        """
    ...
    def _find_insertion_point_recursive(self, node: BinaryTreeNode[T]) -> Optional[BinaryTreeNode[T]]:
        """
